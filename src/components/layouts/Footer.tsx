    ...
    <footer className='max-w-[1200px] text-white mx-auto  border-t-[10px] py-10 px-6  border-[#0a3f9b]'>
      ...
      <div className='gap-y-10 grid md:grid-cols-12'>
        ...
        <div className='md:col-span-5 text-lg font-medium flex flex-col'>
          <Link to={'/'} className='mb-4'>Chính sách bảo mật</Link>
          <Link to={'/'} className='mb-4'>Chính sách giao hàng</Link>
          <Link to={'/'} className='mb-4'>Chính sách bảo hành & đổi trả</Link>
          <Link to={'/'} className='mb-4'>Chính sách bán hàng</Link>
        </div>
      </div>
    </footer>
  )
