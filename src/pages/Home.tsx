    ...
    <>
      <div className='grid md:grid-cols-3 gap-4'>
        <div className='md:col-span-2 text-white space-y-4'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 py-3.5 gap-2'>
              {listThe.map((item, index) => (
                <div
                  ...
                  key={index}
                  className={`${activeNCC?.type === item?.type ? 'bg-[#0046c0]' : 'bg-white'
          ...
          >
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 py-3.5 gap-2'>
              {activeNCC?.menhgia ? activeNCC?.menhgia?.map((item: any, index: number) => (
                <div
                  onClick={() => setActiveMenhGia(item)}
                  key={index}
                  className={`${activeMenhGia === item
        ...
        >
            ...
            {paymentMethods.map((item, index) => (
              <div className='relative'>
                <div
                  ...
                  key={index}
                  className={`${activePayment?.slug === item.slug ? 'border-[#c32ef9]' : 'border-[#4aa100] '
                ...
                <p className=' w-full h-max text-center text-xs font-medium'>
                  {item.title}
                </p>
          ...
          <div className='flex flex-col md:flex-row gap-y-5 md:gap-x-6'>
            ...
            <div className='w-full md:flex-1 space-y-3'>
              <div className='flex flex-col '>
                ...
                <input
                  id='email'
                  className={`bg-white px-3 py-2 rounded w-full ring-2 ${isValid !== null && !isValid ? 'ring-[#ff5252]' : 'ring-white'
                    }  text-gray-600`}
                  type='email'
                  value={email}
              ...
              <div className='flex flex-col '>
                ...
                <input
                  ...
                  className={`bg-white px-3 py-2 rounded w-full ring-2  ${isValidPhone !== null && !isValidPhone ? 'ring-[#ff5252]' : 'ring-white'
                    } text-gray-600`}
                  type='text'
          ...
          <button className='bg-[#c32ef9] uppercase sticky bottom-0 font-medium h-[52px] w-full rounded-md'>
            Thanh toán ngay
          </button>
        </div>
      </div>
      ...
      >
        <div
          ...
          className='bg-white flex flex-col rounded max-w-[800px] w-[90%] h-[90vh] absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2'
        >
          ...
          <div className=' grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 p-5 '>
            {listBank?.map((item: any, index: number) => (
              <div
                ...
                key={index}
                className={`${activeBank === item ? 'border-[#c32ef9]' : 'border-[#4aa100]'
